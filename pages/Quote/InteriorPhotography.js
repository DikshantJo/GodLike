  ...
  async function onSubmitForm(data) {
    ...
    Object.entries(data).forEach(([key, value]) => {
      if (key === "References") {
       ...
       formdata.set('Page', 'Interior photography');
  ...
  return (
    <section className={`pt-24 ${styles.main}`}>
      ...
      <div className="text-center mb-0 lg:mb-8 mt-6 lg:mt-12">
        <h2 className="text-3xl lg:text-6xl text-primary font-bold mb-4 lg:mb-8">
      ...
      <div className=" flex flex-col lg:flex-row 2xl:w-[1300px] mx-auto" style={{background:'#fbfbfb',borderRadius:'24px',boxShadow: '0px 0px 60px 30px rgba(0, 0, 0, 0.03)'}}>
        ...
        <div className="flex lg:w-[55%] flex-col justify-center mt-8 mx-4">
          <form
            className="text-primary mb-3 contact-form w-full max-w-xl"
