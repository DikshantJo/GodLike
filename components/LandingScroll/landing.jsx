  ...
  return (
    <main className={`${styles.main} mx-auto`}>
      ...
      <div ref={gallery} className={styles.gallery}>
        <Column images={[images[0], images[1], images[2],images[2],images[2]]} y={y}/>
        <Column images={[images[3], images[4], images[5],images[2],images[2]]} y={y2}/>
        <Column images={[images[6], images[7], images[8],images[2],images[2]]} y={y3}/>
