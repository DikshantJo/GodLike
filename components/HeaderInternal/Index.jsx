...
export default function index() {
    ...
    useEffect(() => {
        const handleScroll = () => {
            const show = window.scrollY > 50; // adjust this value to change when the background should change
            if (show) {
                setIsScrolled(true);
            } else {
                setIsScrolled(false);
    ...
    return (
        <div className={styles.header} style={ isScrolled ? {backgroundColor: '#1a1a1a'} : {backgroundColor: 'transparent'}}>
            <div className={`${styles.bar} `}>
                <Link href="/"><img style={{height:'10vh'}} src='/header/Logo white_website.png'></img></Link>
                <div  className={styles.el}>
                    ...
                    <div onClick={() => {setIsActive(!isActive)}} className='flex justify-center items-center mt-3' >
